      ...
      <div className="main-container">
        <nav className="nav-bar">
          <img
            ...
            alt="website logo"
          />
          <ul className="score-timer-list">
            <li className="score-list">
              <p className="para1">
                Score: <span className="para2">{score}</span>
              </p>
            </li>
        ...
        <div className="contents-container">
          {!isTrue && (
            <div className="parent1">
              <img className="img3" src={imgUrl} alt="match" />
                ...
                {thumbnailList.map(eachObj => (
                  <li key={eachObj.id}>
                    <button
                      type="button"
                      className="button2"
                      onClick={() => this.onClickImage(eachObj.thumbnailUrl)}
                    >
                      <img
                        className="img4"
          ...
          {isTrue && (
            <div className="parent2">
              <img
                ...
                alt="trophy"
              />
              <p className="para4">YOUR SCORE</p>
              <p className="para5">{score}</p>
              <button
                type="button"
                className="button3"
